...
public class BlockShallowSlope extends Block {
	...
	public static enum SlopeType {
		UPPER_NORTH(0,0,0,1,1,1),
		UPPER_EAST(0,0,0,1,1,1),
		UPPER_SOUTH(0,0,0,1,1,1),
		UPPER_WEST(0,0,0,1,1,1),
		LOWER_NORTH(0,0,0,1,.5,1),
		LOWER_EAST(0,0,0,1,.5,1),
		LOWER_SOUTH(0,0,0,1,.5,1),
		LOWER_WEST(0,0,0,1,.5,1);
